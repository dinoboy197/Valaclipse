...
import valaclipse.builder.ValaBuilder;

public class ValaNature implements IProjectNature {

	public static final String NATURE_ID = "valaclipse.nature";

	// hold a reference to the current project
	...
	public void configure() throws CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(ValaBuilder.BUILDER_ID)) {
				return;
			}
		}
		...
		command.setBuilderName(ValaBuilder.BUILDER_ID);
